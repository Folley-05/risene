...
class EntreprisesFactory extends Factory
{
    ...
    public function definition()
    {
        return [
			...
			'avoirfilialeetranger'=>$this->faker->boolean,
			'partcapitaltierce'=>$this->faker->boolean, 
			'parttierceCapital'=>$this->faker->boolean, 
			'etrefilialtierce'=>$this->faker->boolean,
			...
			'tenuecomptaecrte'=>$this->faker->boolean, 
			'affcabcompta'=>$this->faker->boolean,
			'tenuecomptaformelle'=>$this->faker->boolean,
			'remplissagedsf'=>$this->faker->boolean,
			'chiffaff'=>$this->faker->numberBetween($min = 10000000, $max = 1000000),
			'chiffaffexp'=>$this->faker->numberBetween($min = 1000000, $max = 1000000),
			'valajoute'=>$this->faker->numberBetween($min = 1000000, $max = 10000000),
			'conape'=>$this->faker->boolean,
			...
			'montantsoutraitanceout'=>$this->faker->numberBetween($min = 1000, $max = 300000),
			...
			'montantLoyer'=>$this->faker->numberBetween($min = 100000, $max = 300000),
			...
			'tel1Siege'=>$this->faker->numberBetween($min = 100000, $max = 300000),
			'tel2Siege'=>$this->faker->numberBetween($min = 100000, $max = 300000),
			'faxSiege'=>$this->faker->numberBetween($min = 100000, $max = 300000),
			...
			'anne'=>$this->faker->date($format = 'Y-m-d', $max = 'now'),
